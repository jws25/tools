...
public class strStr {
	...
	StringBuilder text = new StringBuilder("'Write a function to find the index of the first occurrence of a substring in a string. Adding remote_change1. Adding Local_change1. Adding remote_change2.'");
